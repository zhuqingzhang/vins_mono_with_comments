...
extern int MAX_CNT;//特征点最大个数 150
extern int MIN_DIST;//特征点之间的最小间隔 30
extern int WINDOW_SIZE;
extern int FREQ;//控制发布traking_result的频率。 设为10hz
extern double F_THRESHOLD;//ransac算法的门限  1.0 pixel
